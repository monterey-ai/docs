...
You can find Slack integration in the **[integration setting page](https://app.monterey.ai/w/default/settings/integrations/)**. Pick Slack integration and follow the guidelines to set it up. If you want to turn the integrations off, you can find the instructions **[here](https://docs.monterey.ai/https://slack.com/help/articles/360003125231-Remove-apps-and-custom-integrations-from-your-workspace)**.

Anyone who has access to your Monterey workspace can set up Slack integration.

**[Create feedback from DM, channel, and thread](/create-from-slack#create-feedback-from-dm-channel-and-thread)**
...
**[Send feedback notifications from Monterey to Slack](/create-from-slack#send-feedback-notifications-from-monterey-to-slack)**
...
**[Send weekly feedback reports from Monterey to Slack](/create-from-slack#send-weekly-feedback-reports-from-monterey-to-slack)**
...
**[User Access](/create-from-slack#user-access)**
