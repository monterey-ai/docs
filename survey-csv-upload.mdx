...
<Tip>
  If a column has the header **Data Source** and contains values like the survey name (e.g., CSAT), that survey name will appear as a navigation item under **Snippets**.
</Tip>
