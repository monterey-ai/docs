...
Creates a new transcript record in your Reforge Insight Analytics workspace.
...
2. **Import text transcripts**: Connect a transcription service to send call transcripts to Reforge Insight Analytics.

3. **Track Social Media Mentions**: Connect Twitter, Facebook, or Instagram to capture mentions or comments about your product.

4. **Sync CRM Data**: Keep your customer and account data in sync between your CRM (like Salesforce or HubSpot) and Reforge Insight Analytics.
