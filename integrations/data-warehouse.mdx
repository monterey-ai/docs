...
<AccordionGroup>
  <Accordion title="Snowflake">
    <h3>Service User</h3>
    Create service user in Snowflake and grant it READ access on the tables you wish to connect. We'll need the following information to finish configuring the integration:
    - host
    - username
    ...
    <h3>Secure Data Sharing (Alternative)</h3>
    Alternatively, you can request our account details and use [Secure Data Sharing](https://docs.snowflake.com/en/user-guide/data-sharing-intro). Secure data sharing allows you to give us targeted access to only the data you want to share.
