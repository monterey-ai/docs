...
You can find Intercom integration on your **[integration setting page](https://app.monterey.ai/w/default/settings/integrations/)**. Follow the instructions to connect your Intercom account. Anyone who has access to both your Monterey workspace and Intercom team can set up Intercom integration.
