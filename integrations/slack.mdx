...
Anyone who has the have the access to the specified Slack channel can create feedback from slack to Reforge Insights even when they do not have access. Only Reforge Insights teammates will be able to view feedback in Reforge Insights.
