...
You can find the Gong integration on your **[integration settings page](https://insights.reforge.com/w/default/settings/integrations/gong)**.

A user with access to both Reforge Insight Analytics as well as Gong will need to authorize the connection.
...
<Steps>
  ...
  <Step title="Once confirmed, you will be returned to Reforge Insight Analytics where you can select transcripts to analyze" />
</Steps>

### Data Collected

Once Gong is connected to Reforge Insight Analytics, we will load a list of recent calls for you to select from.
...
If you do not have access to Gong, but have call transcripts, you can still upload them directly to Reforge Insight Analytics by navigating to the
