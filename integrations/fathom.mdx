---
title: "Fathom"
description: "Automatically import video call transcripts from Fathom into Reforge Insight Analytics"
---
...
1. A Reforge Insight Analytics account with admin access
2. A Fathom account
3. A Zapier account (free or paid)
4. An API key from your Reforge Insight Analytics workspace
...
1. For the action, search for and select "Reforge Insight Analytics"
2. Choose "Submit New Fathom Transcript" as the action
3. Connect your Reforge Insight Analytics account using your API key
4. Map the fields from Fathom to Reforge Insight Analytics as described in the next section

## Field Mapping

When setting up the Zap, you'll need to map fields from Fathom to the corresponding fields in Reforge Insight Analytics. Here's how to map each required field:

| Reforge Insight Analytics Field | Fathom Field                              |
| ------------------------------- | ----------------------------------------- |
| Transcript ID                   | ID                                        |
...
2. Zapier will send a sample transcript to Reforge Insight Analytics
3. Check your Reforge Insight Analytics workspace to verify the transcript was imported correctly
4. If successful, name your Zap (e.g., "Fathom Transcripts to Reforge Insight Analytics") and turn it on
...
2. **Verify API key**: Make sure you're using a valid API key from your Reforge Insight Analytics workspace
...
- The integration requires both Fathom and Reforge Insight Analytics accounts to remain connected in Zapier

## Access

Only administrators of your Reforge Insight Analytics workspace can set up the Fathom integration through Zapier.