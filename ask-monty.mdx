...
- Themes: the query is bested answered via clustering the data into a few key topics
- Examples: the query is best answered via listing example feedback
- User Story: the query is best answered via a generated user story
- PRD: the query is best answered via a generated a draft product requirement document
