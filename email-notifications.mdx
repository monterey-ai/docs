...
Receive alerts when anomalies are detected within existing themes. Monterey's AI highlights unexpected patterns, helping your team respond to emerging issues before they escalate.

![anomalies](/images/email-notifications/anomalies.png)

## Managing Preferences

Navigate to the [email setting page](https://app.monterey.ai/w/default/settings/emails/) to customize the types of emails you receive.
