...
When auto-triage is enabled for a particular label, Reforge Insight Analytics will go ahead and auto assign a project area label when the feedback is ingested or the labels are backfilled, provided our AI models are confident in that prediction.
