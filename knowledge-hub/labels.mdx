---
title: "Label Management (legacy)"
description: "Creating, managing and tuning labels for feedback triage."
---

## Overview

Project areas and tags are workspace-defined labels that help triage feedback snippets.
When auto-triage is enabled for a particular label, Reforge Insights will go ahead and auto assign a project area label when the feedback is ingested or the labels are backfilled, provided our AI models are confident in that prediction.
...
<Frame caption="Create/Update Label: Descriptors">
  ![](/images/knowledge-hub/new_label_frame_1.png)
</Frame>

<br />

<Frame caption="Create/Update Label: Snippet Examples">
  ![](/images/knowledge-hub/new_label_frame_2.png)
</Frame>
...
<Frame caption="Collecting Human-Labeled Examples">
  ![](/images/knowledge-hub/human_labels.png)
</Frame>
...
<Frame caption="Managing Existing Human Label Examples">
  ![](/images/knowledge-hub/previous_labels.png)
</Frame>
