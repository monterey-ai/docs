...
At the time of this writing, Custom MCPs are only available for Pro, Team, Enterprise, and EDU plans. They are also unavailable for users in the EEA, Switzerland, and the UK.

1. In ChatGPT, navigate to Settings -> Connectors and hit the "Create" button
2. Create a new connection with the following information:

Name: Reforge Insights
MCP Server URL: https://insights.reforge.com/api/v1/mcp
