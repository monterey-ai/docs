...
<Steps>
  <Step title="Choose a subdomain">
    Typically, this would be your company name! You can add additional subdomains by clicking the "Add Domain" button at the top of the page. Each subdomain can have its own unique branding settings.
  </Step>
