...
There is an additional option here - "Feedback Tracking" that can be enabled. This will allow users to view feedback submitted to your workspace from **any** source by them, or users in the same organization.
