---
title: "Survey"
description: "Add data from any supported Survey Provider, upload a Survey CSV, or Create a Reforge Insights Survey!"
---
...
One feature we're proud to support is the creation of guided AI surveys directly through Reforge Insights. Simply write a prompt describing the kind of problem you're looking to solve and Monty will lay out a survey template with questions pre-populated and the best contacts to send to picked out for you.
