...
description: "Now in Open beta. An AI interviewer that generates a plan, runs realistic interviews asynchronously (audio or text), and analyzes results—no scheduling, coordination, or note-taking needed."
---
...
3. **Set the tone:** Review interviewer voices and personalities to get the tone right.
...
<Tip>
  Curious to see how it works? [Try a demo of the Interviewer here.](https://www.reforge.com/research/interviewer)
</Tip>