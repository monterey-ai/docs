...
Some email providers and security tools can disrupt the normal email-sign in flow supported in Reforge Insights, as the link sent to the provided address is mis-handled and ends up incorrect once clicked.
...
<Steps>
  ...
  <Steps title="Go to your email and find the email from Reforge Insights">
  ...
  <Steps title="Return to the page left open on Reforge Insights" />
