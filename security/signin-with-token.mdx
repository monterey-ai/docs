...
Some email providers and security tools can disrupt the normal email-sign in flow supported in Reforge Insight Analytics, as the link sent to the provided address is mis-handled and ends up incorrect once clicked.
...
<Steps>
  <Steps title="Navigate to the Sign In page">
    ...
    [https://insights.reforge.com/auth/signin](https://insights.reforge.com/auth/signin)
  </Steps>
  ...
  <Steps title="Go to your email and find the email from Reforge Insight Analytics">
  ...
  <Steps title="Return to the page left open on Reforge Insight Analytics" />
