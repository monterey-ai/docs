---
title: "SSO"
description: "SSO Setup with Okta"
---

Thank you for your interest in setting up SSO with Monterey AI via Okta. This guide will walk you through the setup process and help you collect the information needed to provide back to us. If you have any questions along the way, please reach out to your primary point of contact with our team, or to [support@monterey.ai](mailto:support@monterey.ai).
...
4. Configure _Sign-in redirect URIs_
   1. Enter the following URI: `https://monterey-ai.auth.us-west-2.amazoncognito.com/oauth2/idpresponse`
   2. **Do not** check the box for _Allow wildcard _ in sign-in URI redirect.\*
5. Configure _Sign-out redirect URIs_
   1. Enter the following URI: `https://app.monterey.ai/auth/signout`
6. Assignments
...
9. Share details with your point of contact at Monterey AI
   ...
   2. **The final set of details that need shared:**
      ...
      2. Client Secret
      3. Okta domain
      4. Email domain(s) users in your organization have that will access Monterey AI (e.g., `@monterey.ai` or `@company.com`). If you need to set up multiple email domains:
         - List all domains that should have access (e.g., `@company.com`, `@subsidiary.com`)
         - Make sure to separate multiple domains with commas
         - Include any subdomains if needed (e.g., `@us.company.com`, `@eu.company.com`)